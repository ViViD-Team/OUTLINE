...
class DividisionNodeData extends NodeData {
    ...
    constructor(outputRefs, context, rawNodeData) {
        ...
        let outputs = [
            new DividisionNodeDataOutput("Frac.", inputs, outputRefs[0], context),
        ];
...
class DividisionNodeDataOutput extends NodeOutputTether {
...
module.exports = DividisionNodeData;